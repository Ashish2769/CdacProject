...
function ViewYourPet() {
  ...
  const getUsers = async () => {
    const response = await fetch(
      ...
      `http://petparadise-env.eba-hnv6tun3.ap-south-1.elasticbeanstalk.com/petparadise/pet/mypets/${userid}`,
      {
  ...
  const handleDelete = (petid, e) => {
    ...
    fetch(
      //  `http://localhost:8080/petparadise/pet/delete/${petid}`,
       `http://petparadise-env.eba-hnv6tun3.ap-south-1.elasticbeanstalk.com/petparadise/pet/delete/${petid}`,
      {
        method: "DELETE",
        headers: {
